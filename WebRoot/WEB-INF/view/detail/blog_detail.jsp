...
<link href="${pageContext.request.contextPath}/css/index.css"
	rel="stylesheet" type="text/css" media="screen" />
<link href="${pageContext.request.contextPath}/css/detail-base.css"
	rel="stylesheet" type="text/css" media="screen" />
<!--[if lt IE 9]>
...
<body>
	<header>
		...
		<nav id="topnav">
			<ul>
				...
				<a class="nav_4" href="${pageContext.request.contextPath}/blogType.do?blogType=002"
					title="BUG本">BUG本</a>
				<a class="nav_3"
	...
	<!--kindedit自带的代码格式化-->
	<link rel="stylesheet"
		href="https://static.yezismile.com/kindeditor/plugins/code/prettify.css" />
	<script
		src="https://static.yezismile.com/kindeditor/plugins/code/prettify.js"
		type="text/javascript"></script>
	<script type="text/javascript"
		src="https://changyan.sohu.com/upload/changyan.js"></script>
	<!--syntaxhighlighter代码高亮插件-->
	<link rel="stylesheet"
		href="https://static.yezismile.com/syntaxhighlighter/styles/shCore.css" />
	<link rel="stylesheet"
		href="https://static.yezismile.com/syntaxhighlighter/styles/shThemeDefault.css" />

	<article>
		<input type="hidden" name="get_title_name"
			value="${blogDetail.blogTitle }" /> <input type="hidden"
			name="get_news_photo" value="${blogDetail.blogImage }" />
		<div style="display: none;" id="get_qrcode_url_id">
			http%3A%2F%2Fwww.aiwen123.cn%2Findex%2Ftitleinfo%2Fid%2F431</div>
		<div class="l_box f_l">
			<!-- banner -->
			<div class="topnews weizhi">
				<h2>
					您现在的位置是： <a href="/index/index">首页</a>&nbsp;>&nbsp; <a
						href="/memory/index?tag=3">${blogTypeName }</a>&nbsp;>&nbsp;
				</h2>
				...
				<div class="news_content">
					...
					<p>
						本文出处：<a
							href="${pageContext.request.contextPath }/blog/detail.do?blogId=${blogDetail.blogId }"
							target="_self">http://www.aiwen123.cn${pageContext.request.contextPath }/blog/detail.do?blogId=${blogDetail.blogId }</a>
					</p>
				</div>
				<!-- 分享+点赞 S -->
				<div class="w_share clearfix">
					<em>分享：</em>
					<div data-tag="share_2"
						class="bdsharebuttonbox bdshare-button-style0-32">
						<div class="whynewcon whynewcon1">
							<i href="javascript:void(0)" class="bds_weixin" title="分享到微信"></i>
						</div>
						<a title="分享到新浪微博" data-cmd="tsina" class="bds_tsina"
							href="javascript:void(0)"></a> <a title="分享到QQ空间"
							data-cmd="qzone" class="bds_qzone" href="javascript:void(0)"></a>
						<a title="分享到QQ好友" data-cmd="sqq" class="bds_sqq"
					...
					<div style="display: none;" class="w_new w_newTop" id="w_new0">
						<div class="pl">
							...
							<span class="shytitle">打开微信，用“扫一扫”扫描二维码，打开页面后分享到朋友圈。</span> <img
								width="187px" height="187px" class="weixinImg"
								src="https://static.yezismile.com/sun/images/wx_logo.jpg" />
						</div>
				...
				<div class="nextpage">
					<p>
						<b>下一篇:</b> <a href="/index/titleinfo/id/430">phpqrcode生成二维码</a>
					</p>
				</div>
		...
		<div class="r_box f_r">
			...
			<div class="tit01">
				...
				<ul class="smile_rank" style="">
					<li><a href="/index/titleinfo/id/431" target="_blank"
						title="阿玉，生日快乐">阿玉，生日快乐</a></li>
	...
	<div id="copright">
		...
		<div>
			Copyright ? 2016 <a href="http://www.aiwen123.cn/" target="_blank">
				www.aiwen123.cn</a>  All rights reserved. 鲁ICP备17028276号-1
		</div>
	</div>
	<!-- ************ - end Footer - 250*200 ************ -->
</body>
...
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shCore.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushPhp.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushXml.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushJScript.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushJava.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushAS3.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushCss.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushPython.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushSql.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushPerl.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushRuby.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushVb.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushCSharp.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushPowerShell.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushJavaFX.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushCpp.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushColdFusion.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushScala.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushGroovy.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushErlang.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushBash.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushDelphi.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushDiff.js"
	type="text/javascript"></script>
<script
	src="https://static.yezismile.com/syntaxhighlighter/scripts/shBrushPlain.js"
	type="text/javascript"></script>
...
$(function(){
	...
	$("div.whynewcon1").hover(function(ev){
		var test = 'http%3A%2F%2Fwww.aiwen123.cn%2Findex%2Ftitleinfo%2Fid%2F431';
		console.log(test);
		var $t = $('#w_new0');
		...
		if ($(".weixinImg").attr("src")=="https://static.yezismile.com/sun/images/wx_logo.jpg"){
			$(".weixinImg").attr("src",'https://www.aiwen123.cn/qrcode/index?url=http%3A%2F%2Fwww.aiwen123.cn%2Findex%2Ftitleinfo%2Fid%2F431');
		}
		$t.show();
